...
import { CART_PNG, DEFAULT_USER_PROFILE, LOGOUT_PNG, ORDER_PNG } from "../../Config/Constants";
    ...
    <div className="navbar">
      ...
      <div className="nav-actions">
        ...
        <div className="dropdown">
          ...
          <ul className="dropdown-menu dropdown-menu-end me-2 mt-2" aria-labelledby="dropdownMenuButton1">
            <li className="nav-dropdown dropdown-item" onClick={()=>Navigate('/my-orders')}>
              <img src={ORDER_PNG} alt="" />
              <p className="m-0">
                Orders
              </p>
            </li>
            <li className="nav-dropdown dropdown-item" onClick={()=>Navigate('/my-cart')}>
